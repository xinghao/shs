<?php
/**
 * CrFramework_Payment_Authorizenet
 * Authorize.net payment gateway handler class
 *   
 *      @version	$Id: Authorizenet.php 5826 2009-07-22 09:18:40Z michaelc $
 *      @package	CrFramework
 *      @subpackage	Payment
...
class CrFramework_Payment_Authorizenet {
   ...
   public function __construct() {
		...
		// if test_mode is true then set to testing gateway url
		if (isset($config->payment->authorizenet->test_mode) && ($config->payment->authorizenet->test_mode==true))
