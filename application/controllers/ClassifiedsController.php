...
class ClassifiedsController extends BusinessController {
    
		
	protected $_busTypeId = 6;
	protected $_busType = 'Classifieds';
    ...
    {
    	return new ClassifiedsRefineForm($business, $location);
    }
     ...
     */
    function  classifiedssearchAction()
    {
    	
    	$this->classifiedsAction();
    	
    }

    function  classifiedsrefineAction()
    {
    	$this->classifiedsAction();
